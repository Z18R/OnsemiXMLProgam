...
Module GeneralModule
    ...
    Public Const ConnectionString As String = "Provider=SQLOLEDB.1;Data Source=DESKTOP-6E9LU1F\SQLEXPRESS;Initial Catalog=MES_ATEC;User ID=sa;Password=18Bz23efBd0J"
