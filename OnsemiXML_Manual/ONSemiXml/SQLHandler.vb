    ...
    Public Function OpenConnection() As Boolean
        Try
            ...
            If String.IsNullOrEmpty(username) Then
                connection = "server=" & server & "; database=" & database & "; connection timeout=30; Trusted_Connection=Yes;"
            Else
                connection = "server=" & server & "; database=" & database & "; user id=" & username & "; password=" & password & "; connection timeout=30"
            End If

            If sql_conn.State = System.Data.ConnectionState.Open Then
                sql_conn.Close()
            End If
